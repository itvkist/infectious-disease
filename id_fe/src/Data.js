...
export const PredictedDiseaseData1m = [
    {
        month: 1,
    },
    {
...
export const PredictedDiseaseData2m = [
    {
        month: 1,
    },
    {
...
export const PredictedDiseaseData3m = [
    {
        month: 1,
    },
    {
...
export const PredictedDiseaseData6m = [
    {
        month: 1,
    },
    {
...
export const PredictedDiseaseData12m = [
    {
        month: 1,
    },
    {
...
export async function updatePredictedDiseaseData() {
    ...
    nextMonths.forEach((next_month) => {
        ...
        fetch(apiUrl, {
            ...
            .then((data) => {
                PredictedDiseaseData1m[8 - 1 + next_month].pneumonia = data.predicted_cases;
            })
            .catch((error) => {
