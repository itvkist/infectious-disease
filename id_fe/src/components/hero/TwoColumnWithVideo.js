...
const Paragraph = tw.p`my-5 lg:my-8 text-sm lg:text-base font-medium text-gray-600 max-w-lg mx-auto lg:mx-0 px-4`;
        ...
        <TwoColumn>
          ...
          <RightColumn>
            <IllustrationContainer>
              <img css={tw`rounded-4xl`} src="/assets/home_0.jpg" alt="Hero" />
              <DecoratorBlob2 />
            </IllustrationContainer>
          </RightColumn>
        </TwoColumn>
